      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_280px]">
        <div>
          <div className="mb-6 flex items-center justify-between">
            ...
            <img src={learner.avatarSrc} alt="" className="h-16 w-16 object-contain" />
          </div>
          <PathBoard units={path.units} chests={path.chests} />
        </div>
        <aside className="space-y-4">
          <div className="card overflow-hidden">
            <img src={media.cherryPath} alt="Cherry blossom path in Japan" className="h-32 w-full object-cover" />
            <div className="p-4">
