...
export default function OnboardingPage() {
  ...
  return (
    <main className="mx-auto grid min-h-screen max-w-5xl items-center gap-8 px-6 py-10 lg:grid-cols-2">
      <div>
        <Img src={media.mochiWave} alt="Mochi waving" className="floaty mx-auto h-56 w-56 object-contain"  width={640} height={480} />
        <div className="overflow-hidden rounded-[32px]">
          <Img src={media.torii} alt="Fushimi Inari torii gates" className="h-64 w-full object-cover"  width={640} height={480} />
        </div>
      </div>
