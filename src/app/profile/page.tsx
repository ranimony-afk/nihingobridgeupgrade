    ...
    <AppFrame learner={learner} active="/profile">
      <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
        <aside className="card p-5 text-center">
          <Img src={learner.avatarSrc} alt="" className="mx-auto h-32 w-32 object-contain"  width={640} height={480} />
        ...
        <div className="space-y-5">
          <section className="card p-5">
            <div className="flex items-center justify-between">
              ...
              <Img src={media.badge} alt="" className="h-10 w-10 object-contain"  width={640} height={480} />
            </div>
