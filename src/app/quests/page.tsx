    ...
    <AppFrame learner={learner} active="/quests">
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <aside className="card overflow-hidden">
          <Img src={media.tokyoAlley} alt="Japanese nightlife alley" className="h-48 w-full object-cover"  width={640} height={480} />
          <div className="p-5">
            <Img src={media.badge} alt="Sakura badge" className="mb-3 h-20 w-20 object-contain"  width={640} height={480} />
