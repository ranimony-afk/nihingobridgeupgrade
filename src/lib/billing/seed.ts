...
export async function ensureBillingSeed() {
  ...
  // Phase 13: AFFILIATE- codes now require a real partner row.
  await db
    .insert(billingAffiliates)
    .values({
      id: "aff-sakura",
      code: "AFFILIATE-SAKURA",
      name: "Sakura Study Blog",
      email: "partner@sakura.example",
      discountPercent: 15,
