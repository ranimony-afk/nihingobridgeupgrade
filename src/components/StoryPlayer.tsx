...
export function StoryPlayer({
  ...
  if (done) {
    return (
      <div className="card p-8 text-center">
        <Img src={media.mochiCelebrate} alt="" className="mx-auto h-40 w-40 object-contain"  width={640} height={480} />
  ...
  return (
    <article className="card overflow-hidden">
      <Img src={cover} alt="" className="h-56 w-full object-cover"  width={640} height={480} />
      <div className="p-6">
