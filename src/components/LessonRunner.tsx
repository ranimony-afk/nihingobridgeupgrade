  ...
  if (done) {
    return (
      <div className="mx-auto max-w-lg text-center">
        <img src={media.mochiCelebrate} alt="Mochi celebrating" className="floaty mx-auto h-48 w-48 object-contain" />
  ...
  if (hearts <= 0 && !feedback) {
    return (
      <div className="card mx-auto max-w-lg p-8 text-center">
        <img src={media.mochiThink} alt="Mochi thinking" className="mx-auto h-36 w-36 object-contain" />
  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-2xl flex-col">
      ...
      <div className={`mt-4 flex items-start gap-3 ${shake ? "shake" : ""}`}>
        <img src={media.mochiThink} alt="" className="hidden h-20 w-20 object-contain sm:block" />
