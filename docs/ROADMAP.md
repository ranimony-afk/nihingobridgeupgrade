...
| 14 | Analytics | Dashboard, learning + business metrics, retention, funnels, revenue | Done |
| 15 | SEO | Schema.org, OpenGraph, RSS, sitemap, internal links, daily blog | Done |
| 16 | Performance | Code splitting, caching, ISR, edge, images, database | Done |
