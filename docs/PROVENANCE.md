...
| `lesson-architecture` | NihongoBridge lesson architecture | `etl/data/lesson-architecture.json` | CC BY-SA 4.0 (NihongoBridge) | authored lesson sections: headings, Japanese headings, body text and Japanese examples |
