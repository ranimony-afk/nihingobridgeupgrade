...
# lesson sections, content blocks and lesson prerequisites
node etl/run-lesson-architecture.mjs

# generated, server-graded lesson exercises
node etl/run-exercise-engine.mjs

# canonical question bank (backfills exercises + generates quiz/JLPT pools)
